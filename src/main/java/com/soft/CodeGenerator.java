...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("123456789");  //如果你的密码不是root，改成自己密码
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
//      pc.setModuleName(scanner("模块名"));
        pc.setParent("com.soft");
        pc.setEntity("entity");   //生成实体类存入到 com.soft.entity
...
//         String templatePath = "/templates/mapper.xml.vm";
        ...
        */
        ...
        //strategy.setSuperEntityClass("com.soft.common.BaseEntity");
        strategy.setEntityLombokModel(true);  //lombok模型
        strategy.setRestControllerStyle(true);  //resutFul风格控制器
        // 公共父类--所有项目 控制器的父类
        strategy.setSuperControllerClass("com.soft.common.BaseController");
        // 写于父类中的公共字段
